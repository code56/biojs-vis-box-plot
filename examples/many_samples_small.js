...
d3.tsv(data_url,function (error,data){
   ...
   //Need a name of all disease states for the sample type
	...
	height: 200,
        ...
        increment: number_of_increments * 0.2, // To double the number of increments ( mutliply by 2, same for 
        // reducing. Number of increments is how many numbers are displayed on the y axis. For none to
        // be displayed multiply by 0
        display: {hoverbars: "yes", error_bars: "yes", legend: "yes", horizontal_lines: "yes", vertical_lines: "no", x_axis_labels: "yes", y_axis_title: "yes", horizontal_grid_lines: "no"},
