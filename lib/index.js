...
module.exports = biojsvisscatterplot = function(init_options)
{
 ...
 /*------------------------------Box plot Calculations--------------------------------------*/
            ...
            if (sort_by_diseases == true) { //There will be a second key which is the disease state
                for (disease_states in values) {
                    ...
                    for (sample_types in disease_values) {
                        ...
                        expression_values = [];
                        number_sample_values = sample_values.length();
    ...
    this.draw_box_plot = function(graph, box_plot_vals, probe, sample_type, disease_state, number_sample_types, id) {
        svg = graph.svg;
        scaleY = graph.scaleY;
        scaleX = graph.scaleX;
        options = graph.options;
        ...
        x_buffer = (probe_size * (probe)) + (disease_state_size * (disease_state + 1)) - (disease_state_size/2) + (;
        //Add min line
        ...
        svg.append("rect")
            ...
            .attr('id', id)
            .attr('y', function(d) {
                //    console.log(box_plot_vals[0]);
                //    console.log(scaleY(11));
                //    console.log(options.height);
                    return scaleY(box_plot_vals[3]);
            })
            .attr('height', function(d) {
                temp = scaleY(box_plot_vals[1]) - scaleY(box_plot_vals[3]);
                console.log(scaleY(box_plot_vals[1]));
                console.log(scaleY(box_plot_vals[3]));
                console.log((box_plot_vals));
