...
module.exports = biojsvisscatterplot = function(init_options)
{
 ...
 /*------------------------------Box plot Calculations--------------------------------------*/
    ...
    this.draw_box_plot = function(graph, box_plot_vals, probe, disease_state, sample_type, number_sample_types, id) {
        svg = graph.svg;
        scaleY = graph.scaleY;
        scaleX = graph.scaleX;
        options = graph.options;
       ...
       //Add box
        ...
        //Add median line
        svg = this.add_line_to_box(options.stroke_width, x_buffer, box_width, box_plot_vals[2], svg, scaleY, colour_median);
        //Add max line
