...
setup_data_violin = function (svgID) {
    ...
    d3.tsv(data_url, function (error, data) {
        ...
        if (sample_type_order != "none") {
            ...
            data.sort(function (a, b) {
                var first = a.Sample_Type;
                var second = b.Sample_Type;
                var val = first.localeCompare(second);
                return val;
            });
        }
        ...
        var instance = init_violin(options_violin);
        return options_violin;
    });
};
